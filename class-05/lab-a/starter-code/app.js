...
// Write your code here
    ...
    function sumAndMultiply(a, b, c) { //eslint-disable-line
        ...
        var mul2 = multiply(multiply(a, b)[0], c)[0];
    
        var ms1 = a + " and " + b + " and " + c + " sum to " + sum1 + ".";
        var ms2 = "The product of " + a + " and " + b + " and " + c + " is " + mul2 + ".";
    
        return [sum1, mul2, ms1, ms2];
}
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    for (var i = 0; i < multArr.length; i++) {
        mu = multiply(mu, multArr[i])[0];
    }

    return [ mu , "The numbers " + multArr[0] + "," +multArr[1] + "," + multArr[2] + " have a product of " + mu + "."]
